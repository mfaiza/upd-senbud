							...
							<table class="display" id="data">
							    ...
							    <tbody>
                                    ...
                                    <tr>
							            ...
							            <td>
							                 <?php echo anchor('user/registeredEkskul/'.$row->id_ekskul,'<button class="btn btn-success"><i class="fa fa-check"></i> Registrasi</button>',array('onclick' => 'return confirm("Anda yakin ingin mengikuti ekskul ini?")'));?> 
							            </td>
							            </tr>
							         <?php } ?>   
